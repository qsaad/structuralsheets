...
export default class CapacityHSS extends Steel {
  ...
  //----------------------------------------------------------
  FlangeCompression() {
    return this.HSS.B_T < 1.12 * this.k()
      ? "Compact"
      : this.HSS.B_T < 1.4 * this.k()
      ? "Non-Compact"
      : "Slender";
  }
  FlangeCompressionX() {
  ...
  WebFlexureX() {
    return this.HSS.H_T < 2.42 * this.k()
      ? "Compact"
      : this.HSS.H_T < 5.7 * this.k()
      ? "Non-Compact"
      : "Slender";
  }
  FlangeCompressionY() {
    return this.HSS.H_T < 1.12 * this.k()
      ? "Compact"
      : this.HSS.H_T < 1.4 * this.k()
      ? "Non-Compact"
      : "Slender";
  }
  WebFlexureY() {
    return this.HSS.B_T < 2.42 * this.k()
      ? "Compact"
      : this.HSS.B_T < 5.7 * this.k()
      ? "Non-Compact"
      : "Slender";
  }
  ...
  beX() {
    if (this.FlangeFlexureX() == "Slender") {
      let b1 =
        1.92 *
        this.HSS.TDES *
        Math.pow(this.E / this.Fy, 0.5) *
        (1 - (0.38 / this.HSS.B_T) * Math.pow(this.E / this.Fy, 0.5));
  ...
  Ieffx() {
    if (this.FlangeFlexureX() == "Slender") {
      ...
      return (
        this.HSS.IX -
        2 *
          ((b1 * Math.pow(this.HSS.TDES, 3)) / 12 +
            b1 *
              this.HSS.TDES *
              Math.pow(this.HSS.HT / 2 - this.HSS.TDES / 2, 2))
      );
    } else {
      this.HSS.IX;
    }
  ...
  Mflbx() {
    ...
    if (this.FlangeFlexureX() == "Non-Compact") {
      let M =
        this.Mpx() -
        (this.Mpx() - this.Fy * this.HSS.SX) *
          (3.57 * this.HSS.B_T * Math.pow(this.Fy / this.E, 0.5) - 4);
  ...
  Mwlbx() {
    if (this.WebFlexureX() == "Compact") {
      ...
      let M =
        this.Mpx() -
        (this.Mpx() - this.Fy * this.HSS.SX) *
          (0.305 * this.HSS.H_T * Math.pow(this.Fy / this.E, 0.5) - 0.738);
      return Math.min(M, this.Mpx());
    }
  } //Mwlbx
  ...
  fMnx() {
    return (
      (ArrayMin(this.Mpx(), this.Mflbx(), this.Mwlbx()) * this.phiF()) / 12
    );
  }
  //---------------------------------------------------------
  //FLEXURE - Y
  ...
  beY() {
    if (this.FlangeFlexureY() == "Slender") {
      let b1 =
        ...
        this.HSS.TDES *
        Math.pow(this.E / this.Fy, 0.5) *
        (1 - (0.38 / this.HSS.H_T) * Math.pow(this.E / this.Fy, 0.5));
  ...
  Ieffy() {
    if (this.FlangeFlexureY() == "Slender") {
      ...
      return (
        this.HSS.IY -
        2 *
          ((h1 * Math.pow(this.HSS.TDES, 3)) / 12 +
            h1 *
              this.HSS.TDES *
              Math.pow(this.HSS.B / 2 - this.HSS.TDES / 2, 2))
      );
    } else {
      this.HSS.IY;
    }
  ...
  Mflby() {
    ...
    if (this.FlangeFlexureY() == "Non-Compact") {
      let M =
        this.Mpy() -
        (this.Mpy() - this.Fy * this.HSS.SY) *
          (3.57 * this.HSS.H_T * Math.pow(this.Fy / this.E) - 4);
  ...
  Mwlby() {
    if (this.WebFlexureY() == "Compact") {
      ...
      let M =
        this.Mpy() -
        (this.Mpy() - this.Fy * this.HSS.SY) *
          (0.305 * this.HSS.B_T * Math.pow(this.Fy / this.E) - 0.738);
      return Math.min(M, this.Mpy());
    }
  } //Mwlby
  fMny() {
    return (
      (ArrayMin(this.Mpy(), this.Mflby(), this.Mwlby()) * this.phiF()) / 12
    );
  }
  flexureParams() {
    return {
  ...
  Fet() {
    return (
      (((Math.pow(Math.PI, 2) * this.E * this.HSS.C) /
        Math.pow(this.Ky * this.Ly, 2) +
        this.G * this.HSS.J) *
        1) /
      (this.HSS.IX + this.HSS.IY)
    );
  } //Fet
  Fe() {
  ...
  Aeff() {
    ...
    return (
      this.HSS.A -
      2 * this.HSS.TDES * (b - this.be()) -
      2 * this.HSS.TDES * (h - this.he())
    );
  }
  Qa() {
    if (
      Math.max(this.HSS.B_T, this.HSS.H_T) >=
      1.4 * Math.pow(this.E / this.Fy, 0.5)
    ) {
  ...
  Fcrt() {
    ...
    if (this.HSS.H_T <= 3.07 * Math.pow(this.E / this.Fy, 0.5)) {
      return (
        (0.6 * this.Fy * (2.45 * Math.pow(this.E / this.Fy, 0.5))) /
        this.HSS.H_T
      );
    } else {
