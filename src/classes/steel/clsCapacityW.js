...
export default class CapacityW extends Steel {
  ...
  Lr() {
    ...
    let v3 =
      6.76 *
      Math.pow(
        (0.7 * this.Fy * this.W.SX * this.W.HO) / (this.E * this.W.J * this.c),
        2
      );
  ...
  Fcr() {
    let v1 =
      ...
      Math.pow(this.Lu / this.W.RTS, 2);
    let v2 =
      ((0.078 * (this.W.J * this.c)) / (this.W.SX * this.W.HO)) *
      Math.pow(this.Lu / this.W.RTS, 2);
  ...
  Mltb() {
    if (this.Lu <= this.Lp()) {
      ...
      var v1 =
        this.Cb *
        (this.Mpx() -
          (this.Mpx() - 0.7 * this.Fy * this.W.SX) *
  ...
  Mflb() {
    ...
    if (this.FlangeFlexure() == "Non-Compact") {
      ...
      return (
        this.Mpx() -
        (this.Mpx() - 0.7 * this.Fy * this.W.SX) * ((l - lpf) / (lrf - lpf))
      );
    } else {
  ...
  Mflby() {
    ...
    if (this.FlangeFlexure() == "Non-Compact") {
      return (
        this.Mpy() -
        (this.Mpy() - 0.7 * this.Fy * this.W.SY) * ((l - lpf) / (lrf - lpf))
      );
    } else {
  ...
  Fet() {
    return (
      ((Math.pow(Math.PI, 2) * this.E * this.W.CW) /
        Math.pow(this.Ky * this.Ly, 2) +
        this.G * this.W.J) *
      (1 / (this.W.IX + this.W.IY))
    );
  } //Fet
  ...
  Qa() {
    ...
    if (this.W.H_TW >= 1.49 * Math.pow(this.E / f, 0.5)) {
      let be =
        ...
        this.W.TW *
        Math.pow(this.E / f) *
        (1 - (0.34 / this.W.BF_2TF) * Math.pow(this.E / f, 0.5));
