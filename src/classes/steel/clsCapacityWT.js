...
export default class SteelWT extends Steel {
  ...
  FlangeFlexure() {
    return this.WT.BF_2TF < this.lpf()
      ? "Compact"
      : this.WT.BF_2TF < this.lrf()
      ? "Non-Compact"
      : "Slender";
  } //FlangeFlexure
  ...
  B() {
    if (this.Lu == 0) {
      ...
      let val =
        2.3 * (this.WT.D / this.Lu) * Math.pow(this.WT.IY / this.WT.J, 0.5);
  ...
  Mltb() {
    if (this.Lu == 0) {
      ...
      return (
        ((Math.PI * Math.pow(this.E * this.WT.IY * this.G * this.WT.J, 0.5)) /
          this.Lu) *
        (this.B() + Math.pow(1 + Math.pow(this.B(), 2), 0.5))
      );
    }
  }
  ...
  Fcrf() {
    ...
    if (this.FlangeFlexure() == "Non-Compact") {
      return (
        this.Fy *
        (1.19 - 0.5 * this.WT.BF_2TF * Math.pow(this.Fy / this.E, 0.5))
      );
    } else {
  ...
  Fet() {
    return (
      ((this.Fey() + this.Fez()) / (2 * this.WT.H)) *
      (1 -
        Math.pow(
          1 -
            (4 * this.Fey() * this.Fez() * this.WT.H) /
  ...
  Fcrt() {
    return (
      ((this.Fcry() + this.Fcrz()) / (2 * this.WT.H)) *
      (1 -
        Math.pow(
          1 -
            (4 * this.Fcry() * this.Fcrz() * this.WT.H) /
              Math.pow(this.Fcry() + this.Fcrz(), 2),
          0.5
        ))
    );
  } //Fcrt
